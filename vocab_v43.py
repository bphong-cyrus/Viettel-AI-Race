# -*- coding: utf-8 -*-
# vocab_v43.py - Based on v39 vocab + targeted additions
# Changes from v39: added missing terms found in GT files
# These are MINIMAL additions - only terms confirmed in GT that were missing from v39

# All v39 SYMPTOMS preserved, plus targeted additions:
SYMPTOMS = [
    # === COPY FROM V39 SYMPTOMS (all entries) ===
    "aphasia",
    "ban đỏ",
    "biến đổi ý thức",
    "biếng ăn",
    ...
    "ợ hơi",
    "ợ nóng",
    # === TARGETED ADDITIONS (minimal - only confirmed missing terms) ===
    "bệnh dại",
    "bệnh dại do",
    "tiêu chảy",
    "lơ mơ",
...
DIAGNOSES = [
    # === COPY FROM V39 DIAGNOSES (all entries) ===
    "Zona thần kinh",
    "addison",
    "alzheimer",
    "amyloidosis",
